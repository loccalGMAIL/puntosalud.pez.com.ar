                                ...
                                <div class="flex items-center gap-3">
                                    <div>
                                     ...
                                     <div class="flex gap-1" x-data="appointmentActions({{ $consulta['id'] }}, {{ $consulta['monto'] ?? 0 }})">
                                         @if($consulta['status'] !== 'attended')
                                             <button @click="sendWhatsAppReminder()" :disabled="loading"
                                                     class="p-1.5 text-xs bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white rounded-md transition-colors duration-200 disabled:cursor-not-allowed"
