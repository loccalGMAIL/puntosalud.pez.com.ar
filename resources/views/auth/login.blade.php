...
<head>
    ...
    <title>Iniciar Sesión - {{ config('app.name', 'PuntoSalud') }}</title>
...
<body class="bg-gradient-to-br from-emerald-50 to-green-100 min-h-screen">
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 xl:w-3/5">
            <div class="relative w-full bg-gradient-to-br from-emerald-600 via-green-600 to-teal-700 flex items-center justify-center overflow-hidden">
                <!-- Imagen de fondo difuminada -->
                <img src="{{ url('back_login.png') }}" 
                ...
                <div class="absolute inset-0 bg-gradient-to-br from-emerald-600/60 via-green-600/50 to-teal-700/60"></div>
                
                <!-- Contenido central -->
                <div class="relative z-10 text-center text-white px-8" style="text-shadow: 2px 2px 4px rgba(0,0,0,0.8);">
                    <p class="text-white leading-relaxed max-w-md mx-auto" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.7);">
                    ...
                    <div class="mt-12 space-y-4 text-left max-w-md mx-auto">
                        <div class="flex items-center text-white" style="text-shadow: 1px 1px 3px rgba(0,0,0,0.8);">
                            <svg class="w-5 h-5 mr-3 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="filter: drop-shadow(1px 1px 2px rgba(0,0,0,0.8));">
        ...
        <div class="w-full lg:w-1/2 xl:w-2/5 flex items-center justify-center px-4">
            ...
            <div class="text-center mb-8">
                <div class="mx-auto h-16 w-16 bg-gradient-to-r from-emerald-500 to-green-600 rounded-full flex items-center justify-center mb-4">
                    <svg class="h-8 w-8 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                </div>
                <h1 class="text-2xl font-bold text-gray-900">PuntoSalud</h1>
                ...
                <button type="submit" 
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-xs text-gray-500">
                            PuntoSalud v{{ config('app.version', '2.2.3') }} - Sistema de Gestión Médica
                        </p>
                    </div>
                </div>
            </div>
