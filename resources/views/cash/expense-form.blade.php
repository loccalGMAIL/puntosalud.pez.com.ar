                    ...
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <div class="text-sm font-medium text-red-800 dark:text-red-200">
                                Salida de Caja - <span x-text="getCategoryLabel()"></span>
                            </div>
                            <div class="text-red-700 dark:text-red-300 mt-1">
                                <span x-text="form.description || 'Sin descripción'"></span>
                            </div>
                            <div class="flex justify-between items-center mt-2">
                                <div class="text-xs text-red-600 dark:text-red-400">
                                    <span x-text="getMethodLabel()"></span> • 
                                    <span x-text="new Date().toLocaleDateString('es-AR')"></span>
                                </div>
                                <div class="text-lg font-bold text-red-800 dark:text-red-200">
                                    -$<span x-text="formatNumber(parseFloat(form.amount) || 0)"></span>
                                </div>
                            </div>
                        </div>
                    </div>
