...
@section('title', 'Análisis de Caja - ' . config('app.name'))
@section('mobileTitle', 'Análisis de Caja')
    ...
    return {
        ...
        async exportReport(format) {
            ...
            if (format === 'excel') {
                ...
                window.location.href = `/cash/report/pdf?${params.toString()}`;
