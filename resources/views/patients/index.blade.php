    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-emerald-200/50 dark:border-emerald-800/30 shadow-sm">
        <div class="p-6">
            ...
            <div class="md:hidden space-y-3">
                ...
                <template x-for="patient in filteredPatients" :key="'mobile-'+patient.id">
                    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 shadow-sm">
                        <div class="flex items-center justify-between mb-2">
                            <span class="font-semibold text-sm text-gray-900 dark:text-white" x-text="patient.last_name + ' ' + patient.first_name"></span>
                            <span :class="patient.is_active ? 'bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400'"
                                  ...
                                  x-text="patient.is_active ? 'Activo' : 'Inactivo'"></span>
                        </div>
                        ...
                        <div class="flex justify-end gap-2 mt-3 pt-3 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <button @click="toggleStatus(patient)"
                                    :class="patient.is_active ? 'text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20' : 'text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20'"
                                    class="p-2 rounded-lg"
                                    :title="patient.is_active ? 'Desactivar' : 'Activar'">
                                <svg x-show="patient.is_active" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M22 10.5h-6m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.5a8.25 8.25 0 0116.5 0v.5H4v-.5z" />
                                </svg>
                                <svg x-show="!patient.is_active" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
