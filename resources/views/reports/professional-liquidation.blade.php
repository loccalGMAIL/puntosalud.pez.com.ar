    ...
    <div class="container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div
            ...
            <div class="space-y-3">
                <!-- Total Facturado -->
                <div
                    class="flex justify-between text-sm font-semibold pb-2 border-b border-emerald-200 dark:border-emerald-800">
                ...
                @if ($liquidationData['totals']['total_collected_by_center'] > 0)
                    <div class="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-3 space-y-2">
                        <div class="flex justify-between text-sm">
                            <span class="text-blue-900 dark:text-blue-100 font-medium">💵 Pagos recibidos en
                                efectivo:</span>
                            <span
                    ...
                    <span class="font-medium text-green-700 dark:text-green-400">+${{ number_format($liquidationData['totals']['professional_commission'], 0, ',', '.') }}</span>
                        ...
                        <div class="flex justify-between text-xs ml-4">
                            <span class="text-blue-700 dark:text-blue-300">Comisión del centro
                                ({{ $liquidationData['totals']['clinic_percentage'] }}%):</span>
                            <span
                                class="font-medium text-gray-700 dark:text-gray-400">${{ number_format($liquidationData['totals']['clinic_amount'], 0, ',', '.') }}</span>
                        </div>
                    </div>
                @endif
                ...
                @if ($liquidationData['totals']['total_collected_by_professional'] > 0)
                    <div class="bg-yellow-50 dark:bg-yellow-900/20 rounded-lg p-3 space-y-2">
                        <div class="flex justify-between text-sm">
                            <span class="text-yellow-900 dark:text-yellow-100 font-medium">🏦 Transferencias al
                                profesional:</span>
                            <span
                ...
                <div class="border-t-2 border-emerald-300 dark:border-emerald-700 pt-3 mt-3">
                    <div class="text-xs text-gray-600 dark:text-gray-400 mb-2 space-y-1">
                        <div class="flex justify-between">
                            <span>Comisión para el profesional sobre pagos en efectivo:</span>
                            <span>+${{ number_format($liquidationData['totals']['professional_commission'], 0, ',', '.') }}</span>
                        </div>
                        @if ($liquidationData['totals']['total_collected_by_professional'] > 0)
                            <div class="flex justify-between">
                                <span>Descuento cobros por transferencia al profesional:</span>
